-- Create app_settings table for global application settings (admin only)
...
-- Allow public read for specific keys (like app_logo) via a function
...
INSERT INTO public.app_settings (key, value) VALUES ('app_logo', NULL) ON CONFLICT (key) DO NOTHING;
INSERT INTO public.app_settings (key, value) VALUES ('app_name', 'KRA ASSIST') ON CONFLICT (key) DO NOTHING;